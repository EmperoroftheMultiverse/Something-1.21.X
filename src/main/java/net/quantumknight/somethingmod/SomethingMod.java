...
public class SomethingMod
{
    ...
    public SomethingMod(IEventBus modEventBus, ModContainer modContainer) {
    ...
    @EventBusSubscriber(modid = SomethingMod.MODID, bus = EventBusSubscriber.Bus.MOD, value = Dist.CLIENT)
